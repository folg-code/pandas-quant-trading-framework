...
class BacktestRunner:
    ...
    def load_data(self):
        ...
        print(f"⏱️ load_data | TOTAL {perf_counter() - t_start:8.3f}s")
        return all_data
    ...
    def run_strategies_parallel(self, all_data: dict):
        ...
        print(f"📈 STRATEGIES | TOTAL {perf_counter() - t_start:8.3f}s")
